...
$(document).ready(() => {
  ...
  dateTomorrow = moment().add(1, "days").calendar();
  dateThree = moment().add(2, "days").calendar();
...
$("#searchButton").on("click", () => {
  ...
  $.get(url).then((response) => {
    ...
    $.get(oneCallURL).then((oneCall) => {
      ...
      dayFourWeather = $("<div>").text(toFarenheit(oneCall.daily[3].temp.day));
      $("#dayFourDiv").append(dayFourWeather);
      dayFiveWeather = $("<div>").text(toFarenheit(oneCall.daily[4].temp.day));
      ...
      weatherDescriptionDayFour = $("<div>").text(
        oneCall.daily[3].weather[0].description
      );
      weatherDescriptionDayFive = $("<div>").text(
